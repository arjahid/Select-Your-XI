...
const Aplayers = ({player}) => {
    ...
    return (
        <div className='w-auto h-auto ml-10 mt-4 border-2 border-gray-300 p-4 gap-4' >
             <div className=''>
             <img src={player_image} alt={player_name} className="w-60 h-60   object-cover mr-4" />
            ...
            <div>
                ...
                <div className='flex items-center justify-between gap-2 pt-3'>
                    <h2>Price: {price}</h2>
                    <button className='ml-12 bg-gray-200 border-spacing-2 rounded-lg px-4 py-2 text-sm font-semibold text-black-500 hover:bg-yellow-300 shadow-md'>Chose Player</button>
                </div>
